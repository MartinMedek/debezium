...
public class MongoShardedUtil {
    ...
    public static List<MongoShardKey> getTestShardKeys() {
        ...
        customersKey.getZones().add(new ZoneKeyRange(OcpShardModelFactory.getShardReplicaSetName(1), "1000", "1003"));
        customersKey.getZones().add(new ZoneKeyRange(OcpShardModelFactory.getShardReplicaSetName(2), "1003", "1004"));
                ...
                .add(new VolumeBuilder()
                        ...
                        .withConfigMap(new ConfigMapVolumeSourceBuilder()
                                ...
                                .withItems(new KeyToPathBuilder()
                                        ...
                                        .withPath(OcpMongoShardedConstants.KEYFILE_PATH_IN_CONFIGMAP)
                                        .build())
                                .build())
                        .build());
    }
