...
public class OcpMongoShardedController implements MongoDatabaseController {
    ...
    public void addShard(Map<MongoShardKey, ShardKeyRange> rangeMap, @Nullable String cerificateConfigMap, @Nullable String certificateFileName) {
        mongo.addShard(rangeMap, cerificateConfigMap, certificateFileName);
    }
